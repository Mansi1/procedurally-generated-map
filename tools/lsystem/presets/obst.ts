...
export const OBST = {
  apfel, apfel_bluete: variant(apfel, 'Blüte', { leafMaterials: bluete, leafSize: 0.45, organs: {} }),
  kirsche, kirsche_bluete: variant(kirsche, 'Blüte', { leafMaterials: ['BlossomWhite'], leafSize: 0.42 }),
  kirsche_japanisch: variant(kirsche, 'Japanische Blüte', { leafMaterials: ['BlossomPink'], leafSize: 0.45, tropism: 0.18 }),
  olive,
