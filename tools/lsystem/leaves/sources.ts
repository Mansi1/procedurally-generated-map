...
export const LEAF_SOURCES = {
  ...
  kastanie: { file: 'Aesculus hippocastanum scanned leaf.png', license: 'CC BY-SA 3.0', author: 'Andrikkos', rotate: 0, tone: 'green' },
  esche: { file: '2020 year. Herbarium. Fraxinus. img-008.jpg', license: 'CC BY-SA 4.0', author: 'Dmitry Makeev', rotate: 0, tone: 'green', crop: [0, 0, 0.07, 0] },
  ...
  walnuss: { file: 'Ruhland, Gutshof 2, Echte Walnuss, Blatt (Oberseite), 01.jpg', license: 'CC BY-SA 4.0', author: 'Wilhelm Zimmerling PAR', rotate: 90, tone: 'green', tolerance: 95 },
  ...
  akazie: { file: '2020 year. Herbarium. Acacia. img-002.jpg', license: 'CC BY-SA 4.0', author: 'Dmitry Makeev', rotate: 0, tone: 'green', crop: [0, 0, 0.07, 0] },
  baobab: { file: 'Adansonia digitata 1DS-II 2574.jpg', license: 'CC BY-SA 4.0', author: 'SAplants', rotate: 0, tone: 'green' },
  fichte: { file: '2020 year. Herbarium. Picea abies. img-007.jpg', license: 'CC BY-SA 4.0', author: 'Dmitry Makeev', rotate: 0, tone: 'green', crop: [0, 0, 0.07, 0] },
  kiefer: { file: '2020 year. Herbarium. Pinus. img-002.jpg', license: 'CC BY-SA 4.0', author: 'Dmitry Makeev', rotate: 0, tone: 'green', crop: [0, 0, 0.07, 0] },
  laerche: { file: 'Larix decidua leaf dimorphism singly or in dense clusters on same tree.jpg', license: 'CC BY-SA 3.0', author: 'unbekannt (siehe Commons)', rotate: 0, tone: 'green', tolerance: 125 },
  zeder: { file: 'E20161008-0003—Cedrus atlantica—Berkeley—DxO (30164010426).jpg', license: 'CC BY 2.0', author: 'John Rusk', rotate: -30, tone: 'green' },
  eibe: { file: 'IfMale branchette.jpg', license: 'CC BY-SA 3.0', author: 'Lamiot', rotate: -90, tone: 'green', tolerance: 85 },
  mammutbaum: { file: 'Riesenmammutbaum Sequoiadendron giganteum top 08.jpg', license: 'CC BY-SA 3.0', author: 'NobbiP', rotate: -90, tone: 'green' },
