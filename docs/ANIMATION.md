...
Offen in Phase 2: IK für die Hände in Blender, Schichten (`walk` + `carry`),
Takt-Marken (`strike`) und das Löschen der Formeln. Solange es die Formeln
gibt, sind sie der Rückfall, falls die Clip-Bibliothek fehlt.
